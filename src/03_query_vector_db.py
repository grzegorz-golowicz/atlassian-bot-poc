...
def perform_search(client, embedder, collection_name, query_text, limit=3):
...
def print_search_results(search_results):
    ...
    for result in search_results:
        ...
        print(f"    - Chunk Text: {result.payload['chunk_text']}")
...
if __name__ == '__main__':
    ...
    query_text = "How many ducks are in a row?"
